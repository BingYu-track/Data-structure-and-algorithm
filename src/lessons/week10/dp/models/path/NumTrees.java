...
public class NumTrees {
    ...
    /*
    通过节点数，计算能构成多少种二叉树
    kp[i]表示第i个节点作为root能构成的二叉搜索树种数；dp[i]表示i个节点能构成的二叉搜索树种类，注意两者是不一样的；
   ...
   TODO: 问题1: 为何是 “以i为根节点的BST种类数 = 左子树BST种类数 * 右子树BST种类数”
    ...
    TODO： 开始以1为根节点，因为是最小的，因此左子树没有节点，剩下的全是大于1的都在右子树上；"构成右子树种类的所有节点就只剩下i-1个，相当于dp[i-1]"
           用 i个节点构建 BST，除去根节点，剩i−1个节点构建左、右子树，左子树分配0个，则右子树分配到i−1 个……以此类推
            左BST        右BST
               0  ...... i-1  ----->以1为根节点
               1  ...... i-2  ----->以2为根节点
                  ......
