        ...
        一、二叉树的存储
          ...
          3.节点个数为n的二叉树，高度是多少?
            ...
            (4)    (5)   (6) -------------3
                 ...
                 (7)  -------------------4
            看网上有2种说法:
                1.二叉树的深度为根节点到最远叶子节点的最长路径上的节点数，按照这个逻辑，上面的二叉树深度就是4
                  二叉树的高度从该节点到叶子节点的最长路径上的节点数，按照该逻辑二叉树高度也是4(见leetcode"二叉树的最大深度"的定义)

               2.树中的某节点的深度是它到根节点的路径上的边的条数，按照该逻辑，上面的二叉树深度是3。(深度是当前节点~~根节点)
                 树中某节点的高度是指从该节点到叶子节点的最长简单路径边的条数，按照该逻辑，上面的二叉树高度用是3。(深度是当前节点~~叶子节点)
